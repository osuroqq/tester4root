    ...
    <div className="flex min-h-[100dvh] flex-col">
      ...
      <main className="flex-1 bg-muted py-12 px-4 md:px-0">
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow p-8">
          ...
          <p className="text-muted-foreground mb-2">This is a placeholder for your cookie policy. Please update this content with your actual cookie policy details.</p>
        </div>
      </main>
